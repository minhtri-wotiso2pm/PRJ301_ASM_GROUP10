...
public class EmailUtils {
    ...
    private static final String EMAIL_USERNAME = "nzero1542005@gmail.com";
    private static final String EMAIL_PASSWORD = "eayuablcsssquloe";
    ...
    public static boolean sendTransactionEmail(
            String toEmail,
            String bookCode,
            String fullName,
            String phone,
        ...
        try {
            ...
            String htmlContent = "<h2>" + fullName + "</h2>"
                    + "<p>" + phone + "</p>"
                    + "<p>" + money + "</p>"
                    + "<p>" + bookCode + "</p>"
                    + "<p>" + paymentID + "</p>"
                    + "<p>" + checkin + "</p>"
                    + "<p>" + checkout + "</p>"
                    + "<br><p style='color: green;'>Cảm ơn bạn đã sử dụng dịch vụ!</p>";
    ...
    public static void main(String[] args) {
        sendRegistrationEmail("nzero1542005@gmail.com", "ALNQ", "ALNQ");
        sendTransactionEmail("nzero1542005@gmail.com", "1", "Le Anh", "0378263237", "700000", "1", "22/07/2025", "23/07/2025");
    }
}
